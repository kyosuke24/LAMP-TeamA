...
function readdata(){
	...
	global $page;
	global $Session_id;
	$Session_id = $_SESSION['j2020tmA_adm']['Admin_id'];
	$obj = new cTop_table();
	$from = ($page - 1) * $limit;
...
function deljob(){
	...
	if($_POST['param'] > 0){
		$chenge->delete("Top_table","Top_id=" . $_POST['param']);
	}
}
